...
/**
 * Instances of this enum marshal/unmarshal <i>double-precision</i> floating-point values normed to range <tt>[-1,+1]</tt>
...
public enum DoubleMarshaler {
	 ...
	 */
	INT_8 (Byte.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) buffer.get(), 1 - Byte.SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
	...
	UINT_8 (Byte.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) (buffer.get() - Byte.MIN_VALUE), 1 - Byte.SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
			buffer.put((byte) round((Byte.MAX_VALUE + .5) * max(0, min(2, value + 1))));
		}
	},
	...
	INT_16 (Short.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) buffer.getShort(), 1 - Short.SIZE);
		}
	...
	UINT_16 (Short.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) (buffer.getShort() - Short.MIN_VALUE), 1 - Short.SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
			buffer.putShort((short) round((Short.MAX_VALUE + .5) * max(0, min(2, value + 1))));
		}
	},
	...
	INT_24 (INT_24_BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) getInt24(buffer), 1 - INT_24_SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
			putInt24(buffer, (int) round(max(INT_24_MIN_VALUE, min(INT_24_MAX_VALUE, scalb(value, INT_24_SIZE - 1)))));
		}
	},
	...
	UINT_24 (INT_24_BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) (getInt24(buffer) - INT_24_MIN_VALUE), 1 - INT_24_SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
			buffer.putInt((int) round((INT_24_MAX_VALUE + .5) * max(0, min(2, value + 1))));
		}
	},
	...
	INT_32 (Integer.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) buffer.getInt(), 1 - Integer.SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
			buffer.putInt((int) round(max(Integer.MIN_VALUE, min(Integer.MAX_VALUE, scalb(value, Integer.SIZE - 1)))));
		}
	},
	...
	UINT_32 (Integer.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) ((long) buffer.getInt() - Integer.MIN_VALUE), 1 - Integer.SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
			buffer.putInt((int) round((Integer.MAX_VALUE + .5) * max(0, min(2, value + 1))));
		}
	},
	...
	INT_64 (Long.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) buffer.getLong(), 1 - Long.SIZE);
		}

		public void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException {
			buffer.putLong(round(max(Long.MIN_VALUE, min(Long.MAX_VALUE, scalb(value, Long.SIZE - 1)))));
		}
	},
	...
	UINT_64 (Long.BYTES) {
		public double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException {
			return scalb((double) buffer.getLong() - Long.MIN_VALUE, 1 - Long.SIZE);
		}
	 ...
	 */
	private DoubleMarshaler (final int valueSize) {
	 ...
	 */
	public abstract double get (final ByteBuffer buffer) throws NullPointerException, BufferUnderflowException;
	 ...
	 */
	public abstract void put (final ByteBuffer buffer, final double value) throws NullPointerException, BufferOverflowException, ReadOnlyBufferException;
	 ...
	 */
	static public DoubleMarshaler valueOf (final boolean floatingPoint, final boolean unsigned, final int valueSize) throws IllegalArgumentException {
		if (floatingPoint) {
			switch (valueSize) {
				case HALF_BYTES:
					return HALF;
