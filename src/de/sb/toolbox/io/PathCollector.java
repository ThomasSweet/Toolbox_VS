...
public class PathCollector extends SimpleFileVisitor<Path> {
	...
	/**
	 * Returns the directory paths visited since the collector was created, or the collection returned was cleared the time.
	...
	/**
	 * Returns the file paths visited since the collector was created, or the collection returned was cleared the time.
